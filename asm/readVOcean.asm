...
++	movw ya,ReadPat
	movw ReadSeq,ya
	jmp KonvertReadPattern
+++	cmp a,#$01 ;terminate pattern/loop on 00 01 (jump)
	beq +++
	mov y,a
	pop a
	movw ReadSeq,ya
...
+++	mov ReadTrackX,#$00
	inc DPatPhrase
	cmp DPatPhrase,#$08 ;do not read more than 8 channels
	bmi +
-	nop
	bra -
+	cmp DPSubFlag,#$00
...
VoiceNoteEvent: ;01-DF
	...
	and a,#$f0
	xcn a
	eor a,#$70 ;treat all 00-7F as velocity with hardcoded quantization
